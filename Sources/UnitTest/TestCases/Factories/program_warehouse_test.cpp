...
public:
	...
	Hackers_Project::data::program_data prepare_stream()
	{
		Hackers_Project::data::program_data data;
...
TEST_F(ut_program_warehouse_test, parsing_program)
{
	Hackers_Project::data::program_data data;
	data.set_name("Brute");
	::Hackers_Project::data::program_data_effect * effect = data.add_effects();
	effect->set_effect(Hackers_Project::data::program_data::attack);
	effect->set_val(1);



	Hackers_Project::data::program_data data1;
	data1.set_name("Tank");
	::Hackers_Project::data::program_data_effect * effect1 = data1.add_effects();
	effect1->set_effect(Hackers_Project::data::program_data::decrypt);
	effect1->set_val(2);
