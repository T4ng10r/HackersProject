...
Hackers_Project::program_data program_generator::load_data(const boost::property_tree::ptree::value_type & val )
{
...
bool program_generator::load(const std::string & dir_path)
{
	...
	{
		Hackers_Project::program_data program_data_ = load_data(v);
